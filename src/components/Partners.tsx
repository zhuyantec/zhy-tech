...
const partners = [
  ...
  { name: 'Raumplus', logoSrc: '/logos/raumplus.svg', id: '3:76', alt: 'Raumplus Logo' },
  { name: 'Richart', logoSrc: '/logos/RICHART.svg', id: '3:98', alt: 'Richart Logo' },
  { name: 'Rosery', logoSrc: '/logos/ROSERY.svg', id: '3:106', alt: 'Rosery Logo' },
